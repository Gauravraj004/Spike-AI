"""
Excel Report Generator - SUPER SIMPLE VERSION
Just plain data, no formatting at all
"""
...
def create_excel_report(results: List[Dict[str, Any]], output_path: str):
    """
    ...
    for idx, result in enumerate(results, start=2):
        ...
        ws[f'F{idx}'] = evidence if evidence else 'N/A'
...
def create_csv_report(results: List[Dict[str, Any]], output_path: str):
    """
    ...
    with open(output_path, 'w', newline='', encoding='utf-8') as f:
        ...
        for result in results:
            ...
            evidence = str(result.get('evidence', 'N/A'))
